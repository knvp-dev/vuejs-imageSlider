...
const app = new Vue({
    ...
    data:{
		slides: [
			{ id: 1, src: '/images/1.jpg', title: 'image 1', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam, a excepturi fugiat nihil in deserunt, natus possimus est atque rem incidunt soluta. Itaque quis dolor perspiciatis natus vel, voluptate possimus.', url: '/' },
			{ id: 2, src: '/images/2.jpg', title: 'image 2', description: 'this is the second image', url: null },
			{ id: 3, src: '/images/3.jpg', title: 'image 3', description: 'this is the third image', url: null },
